    ...
    <div style={{ maxWidth: 1040, margin: "0 auto", padding: "100px 24px 80px" }}>
      ...
      <div style={{ marginBottom: 56 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(290px, 1fr))", gap: 16 }}>
          ...
          <PriceCard t={t} colorScheme="teal" title="Negotiation Coaching" original="250" price="150" features={["Salary & offer negotiation strategy", "Scripts and frameworks", "Salary, stock, benefits & more"]} />
          ...
          <PriceCard t={t} colorScheme="warm" title="Resume Review & Rewrite" original="500" price="350" features={["2 sessions for deep-dive review", "ATS & AI optimization guidance", "Rewrite with insider knowledge"]} />
